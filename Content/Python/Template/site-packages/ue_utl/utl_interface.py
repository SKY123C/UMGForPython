...
class UnrealUTLInterface(UnrealInterface):
    ...
    @add_logger
    def get_asset_by_path(self, path: Union[str, List[str]], recursive=False, alllow_class_list=None):
        """
        通过路径获取资产
        """
        result = []
        ...
        for p in path:
            ...
            asset_data_list.extend(asset_registry.get_assets_by_path(p, recursive=recursive))
